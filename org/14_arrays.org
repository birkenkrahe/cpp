...
- In your practice file, create a new code block to print the elements
  of a 2 x 2 matrix ~foo~. Write the pseudocode first:
  #+begin_example
  // declare 2 x 2 matrix of floating-point values
  ...
  #+begin_src C
    // Declare a 2 x 2 matrix
    float foo[2][2] = {0.f}; // only for {0.f} will all elements be set
    // print matrix
    // iterate over the row indices
    for (int row = 0; row < 2; row++) {
      // iterate over the column indices
      for (int col = 0; col < 2; col++) {
        //print matrix element in row,col
        printf("%2.0f",foo[row][col]);
      }
     }
  #+end_src
