...
- ~#+HONOR:~ is not a thing - metadata aren't arbitrary: Write ~(pledged)~
  next to your name in the ~#+AUTHOR:~ line
...
- *No documentation* in a literate program is not a thing: if you use
  ...
  you're doing (and not just the AI).

- You can only use advanced concepts like these if you can explain
  them to me!

- Documentation is not source code (// ???)

- Do append your solutions as a *new section* ~* Solution~

- You can *resubmit* after fixing your errors for full points. I will
  not *remind* you individually anymore - just resubmit!
...
- Working on assignments together is fine but make sure that you can
  ...
  conversion: you can arrive at one solution, but then run and test
  your personal submission with different phone numbers.

- You'll get my sample solutions after all is done.

** Review & practice C operators: [[http://tinyurl.com/8-operators-org][tinyurl.com/8-operators-org]]
