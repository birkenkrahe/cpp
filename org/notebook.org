...
** DONE Test 9 (functions) is ready for you to complete by May 1 (Wednesday)
...
** IN PROGRESS New topic: pointers! C's secret memory management weapon
...
3) What happens when you apply =&= to a pointer ~*p~?
   ...
   #+RESULTS:
   : value of i: 10
   : referenced pointer value of i = address: 0x7ffd6f89e25c
