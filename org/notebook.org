...
* DONE Week 10 - Process models / Selection statements (ifelse)
#+attr_html: :width 400px:
[[../img/week_10.png]]
...
- Many of you lost points for lacking documentation
- For full points, resubmit your files with documentation
- Documentation not in the code blocks but outside of them
- Made videos for the BPMN exercises (models from pseudocode)
  
* Week 12 - Loops (while,for,do...while)
* Week 13 - Arrays
* Week 14 - Functions
* Week 15 - Pointers
* Week 16 - From C to C++
