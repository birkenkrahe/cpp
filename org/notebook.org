...
** DONE Test 6 available until Sunday, April 14
...
** DONE Teaching demonstration Wednesday 4 pm in Derby 016

- *Candidate talk:* Wednesday, 10 April at 4 pm in Derby 016
  #+attr_html: :width 200px:
  [[../img/wenhui.png]]

** DONE Fall'24: Data Structures (CSC 240) - Spring'25: Algorithms (CSC 265)
...
** DONE Review: counting with =while= and with =do= ... =while=
...
** TODO Review: looping with =for=, =break=

1. =break= only gets you out of the innermost loop

** TODO Lab: practicing loops with =while=, =do =... =while=, and =for=
