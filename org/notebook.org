...
** DONE Loop lab: Understanding a problem before coding it
#+attr_html: :width 200px:
[[../img/factorial.png]]
...
** DONE Test preview/review: loops
...
** DONE Review: Array declaration and length
...
1) What's a macro? Give an example?
   #+begin_src C
     #define PI 3.1452
     #define N  10
   #+end_src
...
5) Can you initialize ~arr[4]~ to 5 4 3 2 1 with a =for= loop?
   #+begin_src C
     #define N 4
     int arr[N];
     for (int i = 5; i > 0; i--) {
...
** TODO Code along: reversing numbers
...
* Week 14 - Functions vs. Procedures
