...
like these if you can explain them to me!
...
4) In which order are =++k=, =k--= and =k+== executed?
   ...
   #+end_src
5) What is =!(!1)= and how could you show that?
   #+begin_src C
     if(!(!1)) {
       puts("!(!1) is TRUE");
      } else {
...
Now, let's practice: [[http://tinyurl.com/8-operators-org][tinyurl.com/8-operators-org]] - finish at home.

** New bonus exercise: prove De Morgan's laws using C ([[https://lyon.instructure.com/courses/2107/assignments/26177][Canvas]])
** Test 4 (C operators) will be available later this week.
