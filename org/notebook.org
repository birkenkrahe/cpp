...
** Remember the final exam on FRIDAY 10-MAY at 1-3 PM here
#+attr_html: :width 400px: 
[[../img/final_exam.png]]

** DONE Contrasting C vs. C++
#+attr_html: :width 400px:
[[../img/c_vs_cpp.png]]

- Download the codealong file: [[https://tinyurl.com/17-cpp-codealong][tinyurl.com/17-cpp-codealong]]
- Save the file as an Org-mode file ~~/cpp.org~
...
- Evaluate the course if you haven't done so yet!
- My last AI picture: celebrating the last C++ class Leonardo style
#+attr_html: :width 600px:
[[../img/final.png]]

=======
>>>>>>> 1f53164 (Update from dell)
* Post-mortem (May 23)

Thanks everyone (actually, 81% of y'all) for the first rate evaluation
of this course - well done. I never get to evaluate "the course" as
such but I enjoyed it very much this time round - except that I could
probably have done better & perhaps next time I will (I bet that's
what you're telling yourself, too, and you may still when you're my
age :-) Enjoy your summer & if you're in need of some coding advice,
or you want to keep your skills fresh, don't hesitate to reach out:
I'm currently working through a few books myself - "Learn C the hard
way", "C++ Crash Course", and "A Tour of C++". Also, I am done with
generative AI images, I think - 1.5 years of fake art is enough. To
celebrate the summer, feast your eye on Monet's "The Summer - poppy
field" (1875). Source: WikiArt.org, public domain.
#+attr_html: :width 400px:
[[../img/monet_summer_poppy_field_1875.png]]
