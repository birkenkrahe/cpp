...
- All lecture materials are in GitHub - you also received a paper copy
  of the script.
...
- I will also grade all outstanding submissions & submit early alerts!
- I will create and post solution videos for practice 5 (constants)
...
* Week 6 - =printf= and =scanf= reloaded

#+attr_html: :width 400px:
[[../img/week_6.png]]

- Review test stats (data visualization)
- Review programming assignments (feedback)
