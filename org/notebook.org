...
* Week 9 - C Operators practice / selection statements
#+attr_html: :width 400px:
...
** Test 4 (C operators) will be available later this week - Tips
#+attr_html: :width 600px: 
[[../img/test_1-4_box.png]]

/Figure: test results lately haven't been exactly stellar (R code)./
