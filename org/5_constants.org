...
#+DATE: Time-stamp: <2024-02-11 23:08:15 marcus>
...
- To *code along during the lecture* using Emacs and Org-mode, download
  *the raw file* [[https://github.com/birkenkrahe/cc/tree/piHome/org][from GitHub]], save it as ~5-codealong.org~ and open it.
